...
import * as strings from 'HrQuickLinksWebPartStrings';
import HrQuickLinks from './components/HrQuickLinks';
import { IHrQuickLinksProps } from './components/IHrQuickLinksProps';

export interface IHrQuickLinksWebPartProps { title: string; }

export default class HrQuickLinksWebPart extends BaseClientSideWebPart<IHrQuickLinksWebPartProps> {
  private _isDarkTheme: boolean = false;

  public render(): void {
    const element: React.ReactElement<IHrQuickLinksProps> = React.createElement(HrQuickLinks, {
